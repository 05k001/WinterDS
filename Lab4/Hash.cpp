...
*bult in list type. I added a timer to the main program to see the running time. Added some
*questions in the comments. It was interesting to check out the stucture of the hash table.
*/
